<template>
  <section
    ...
    class="
      ...
      py-12
      sm:py-24
      bg-cover bg-bottom bg-[url('~/assets/img/bg/features.jpg')]
      dark:bg-[url('~/assets/img/bg/features-dark.jpg')]
    "
  >
    <div>
            ...
            >
              <div
                ...
                class="
                  ...
                  py-1
                  px-4
                  lg:rounded-r-none lg:rounded-l-xl lg:p-6
                "
                :class="[
                  index === selectedTab
...
const features = [
...

  {
    ...
    description: "DX@Scale's CI/CD practices and tools are compatible with all major CI/CD platforms, reducing your mainteance costs",
