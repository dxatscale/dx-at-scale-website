<template>
  <section aria-label="What is DX@Scale?" class="relative overflow-hidden bg-slate-50 dark:bg-slate-900 pt-20 pb-28 sm:py-32">
    <img class="absolute top-1/2 left-1/2 max-w-none translate-x-[-44%] translate-y-[-42%]"
      src="~/assets/img/backgrounds/features.jpg" alt="" width=2245 height=1636 />
    <div class="max-w-7xl mx-auto relative px-4">
      <div class="dark:text-white/70 max-w-2xl md:mx-auto md:text-center xl:max-w-none">
        <h2 class="py-12 text-center text-base font-semibold uppercase text-pink-600 dark:text-pink-400 tracking-wider">What is DX@Scale?
        </h2>
        <p class="text-lg tracking-tight dark:text-slate-400">
