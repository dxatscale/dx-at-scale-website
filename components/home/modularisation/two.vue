    ...
    <vscode>
      <div class="mt-2">
        ...
        <div class="flex py-1">
          ...
          <p class="w-32 truncate">config</p>
        </div>
        ...
        <div class="flex rounded-sm bg-sky-600/10 py-1 text-sky-600 dark:bg-slate-700/50 dark:text-sky-300">
          <svg class="mr-1 ml-4 w-4 text-slate-400" viewBox="0 0 16 16">
            <path
              fill="currentColor"
              fill-rule="evenodd"
          ...
          <p class="w-32 truncate">sfdx-project.json</p>
        </div>
      </div>
      <template v-slot:code>
        <shiki class="code" :code="code" lang="json" />
      </template>
    </vscode>
  </home-modularisation-benefits>
</template>
